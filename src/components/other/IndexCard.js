    ...
    <div className="bg-gradient rounded-md pt-12 my-10 mx-3 height-max-content custom-pink-box-shadow text-lighter-blue font-black">
      ...
      <div className="bg-darker-blue rounded-b-md p-5">
        ...
        <p className="text-xl xl:mx-12 text-center">
          ...
          <div className="xl:inline">in or</div>
        
          <Link to="/signup" className="block xl:inline w-full hover-pink-button rounded-lg pink-blue-gradient py-3 px-12  text-darkest-blue font-extrabold custom-inner-box-shadow text-xl">
            Sign up
          </Link>
        </p>
