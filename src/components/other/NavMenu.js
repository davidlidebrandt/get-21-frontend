    ...
    <nav className="hidden xl:grid h-full bg-darker-blue text-xl place-items-center text-darkest-blue relative">
      <div className="w-full">
        ...
        <div className="px-14">
          ...
          {
            currentPage !== "signup" ? (
              <Link to="/signup" className="text-center block my-10 m-auto py-4 rounded-lg pink-blue-gradient w-full text-white font-extrabold custom-inner-box-shadow hover-pink-button">
              Sign Up 
            </Link>
            ) : ( null )
          }
          ...
          <button onClick={()=> {setDisplayHelp("")}} className="text-center block my-10 m-auto  py-4 w-full rounded-lg bg-gradient font-extrabold custom-inner-box-shadow hover-button">
            Help 
          </button>
        </div>
      </div>
