  ...
  return (
    <>
      <div
        className={
          displayMenuModal +
          " absolute top-0 left-0 w-full px-10 bg-gradient custom-inner-box-shadow z-50"
        }
      >
        <div className="w-1/3 m-auto">
          ...
          {currentPage !== "signup" ? (
            <Link
              to="/signup"
              className="text-center block my-10 m-auto py-4 rounded-lg pink-blue-gradient w-full font-extrabold custom-inner-box-shadow hover-pink-button"
            >
              Sign Up
            </Link>
          ) : null}
          <button
            onClick={() => {
              setDisplayMenuModal("hidden");
              setDisplayHelp("");
            }}
            className="text-center block my-10 mb-0 m-auto w-full py-4 rounded-lg bg-gradient font-extrabold custom-inner-box-shadow hover-button"
          >
            Help
          </button>
          <button
