    ...
    <div className="bg-gradient w-full rounded-md pt-12 my-10 mx-3 height-max-content custom-pink-box-shadow text-lighter-blue font-black">
      ...
      <div className="bg-darker-blue rounded-b-md p-5">
        ...
        <div className="text-xl xl:mx-12 text-center">
          <Link to="/login" className="block xl:inline w-full hover-button rounded-lg bg-gradient text-white py-3 px-12 font-extrabold custom-inner-box-shadow text-xl">
            Log in
          </Link>
